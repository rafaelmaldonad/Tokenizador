<?php
    ...
    $query = "SELECT s.KQ2_ID_MEDIO_ACCESO,s.KQ2_ID_MEDIO_ACCESO_DES,s.MONTOA,s.TXSA,w.MONTOR,w.TXSR FROM (
...
<head>
  ...
  <script type="text/javascript">
      ...
      function grafica() {
        ...
        ["MedioAcceso","Aceptadas","Rechazadas"],
          <?php
            for($i=0; $i<count($info); $i++){
                print "['".$info[$i]["KQ2_ID_MEDIO_ACCESO"]."', ".$Atotal[$i].", ".$Rtotal[$i]."]";
  ...
  <div class="content-wrapper" style="background:white !important">
   ...
   <div class="content-header text-center">
      <div class="container-fluid text-center">
        <div class="row mb-2">
          <div class="col-sm-12">
            <h1 class="m-0 text-center text-dark display-2">Análisis por Medio de Acceso </h1>
          </div><!-- /.col -->
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header text-center">
                    <h2 class="card-title">Medio de Acceso</h2>
                </div>
                <div class="card-body">
                    <table id="example1" class="table table-bordered table-striped">
                        <thead class="bg-dark">
                        <tr>
                            <th>kq2 Medio Acceso</th>
                            <th>Txs Aceptadas</th>
                        ...
                        <tbody>
                            <?php for($i=0;$i<count($info);$i++) { ?>
                                <tr>
                                    <td><?php echo $info[$i]["KQ2_ID_MEDIO_ACCESO"]." - ".$info[$i]["KQ2_ID_MEDIO_ACCESO_DES"]; ?></td>
